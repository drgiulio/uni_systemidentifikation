...
%%%%%                      (c) 06.10.2013                             %%%%%
%%%%%          Christian Endisch, TH Ingolstadt, TU M�nchen           %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                         %
%                           Init Duffing System                           %
%                                                                         %        
...
[DL,ldel] = setDL(1,2,[1:3],DL,ldel);       %Schicht 1 zur�ckgef�hrt mit 
[DL,ldel] = setDL(1,3,[1:3],DL,ldel);       %zeitl. Verz�gerung (3)
[DL,ldel] = setDL(2,1,[0],DL,ldel);         %Normale Forward connection
[DL,ldel] = setDL(2,2,[1:3],DL,ldel);       %Eigenr�ckkopplung mit Verz�gerung (3)
[DL,ldel] = setDL(2,3,[1:3],DL,ldel);       %R�ckkopplung von 3 nach 2 mit zeitl. Vrz. (3)
[DL,ldel] = setDL(3,2,[0],DL,ldel);         %Normale Forward connection
[DL,ldel] = setDL(3,3,[1:3],DL,ldel);       %Eigenr�ckkopplung mit Verz�gerung (3)
